...
const randomNearbyLocation = (location: string) => {
  const streets = [
    'King St', 'Queen St', 'Dundas St', 'College St', 'Bloor St',
    'Spadina Ave', 'Bathurst St', 'Yonge St', 'Bay St', 'University Ave'
  ]
      ...
      <div class="bg-teal-700 text-white py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center">
            <button 
              @click="goBack" 
              class="mr-4 p-1 rounded-full hover:bg-teal-600 transition-colors"
            >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div class="lg:col-span-2 space-y-6">
              ...
              <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                  ...
                  <div class="flex items-center">
                    ...
                    <span class="text-sm text-gray-500">Reported {{ timeAgo(report.dateSubmitted) }}</span>
                  </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
              <div class="p-6">
                ...
                <div class="bg-gray-200 rounded-lg h-64 flex items-center justify-center">
                  ...
                  <span class="ml-2 text-gray-500">Map placeholder for {{ report.location }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
              <div class="p-6">
                <h2 class="text-xl font-semibold text-gray-900 mb-4">Comments ({{ report.comments.length }})</h2>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
              <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative flex items-start space-x-3">
                      <div>
                        <div class="relative px-1">
                          <div class="h-8 w-8 bg-teal-500 rounded-full flex items-center justify-center ring-8 ring-white">
                  ...
                  <div v-if="report.status === 'resolved' || report.status === 'closed'" class="relative pb-8">
                    <span v-if="report.status === 'closed'" class="absolute top-4 left-4 -ml-px h-full w-0.5 bg-gray-200" aria-hidden="true"></span>
                    <div class="relative flex items-start space-x-3">
                      <div>
                        <div class="relative px-1">
                  ...
                  <div v-if="report.status === 'closed'" class="relative">
                    <div class="relative flex items-start space-x-3">
                      <div>
                        <div class="relative px-1">
                          <div class="h-8 w-8 bg-gray-500 rounded-full flex items-center justify-center ring-8 ring-white">
